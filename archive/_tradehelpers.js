...
let UNI = new Token(chainId, address1, decimals1)
  ...
  console.log(`${amountIn} ${symbol0} can be swapped for ${route.quote.toFixed(6)} ${symbol1}`)
...
exports.uniSwapOptimumTrade = async (amountIn, poolAddress, tokenIDs, tokenPath, tokenDecimals) => {
  ...
  console.log(`${amountIn} ${symbol0} will be swapped for ${route.quote.toFixed(10)} ${symbol1}`)
...
/*
exports.uniSwapOptimumTrade = async (amountIn, poolAddress, tokenIDs, tokenPath, tokenDecimals, initalAmountIn) => {
	const chainId = 137
  const router = new AlphaRouter({ chainId: chainId, provider: provider})
