...
const main = async() =>{
    ...
    let maticPrice = 0.75
    console.log(" ")
    console.log("ARB INV POLLING STARTED")
    console.log("-------------------")

    let priceMonitor = setInterval(async () => { 
        console.log(" ")
        console.log("ARB INV POLLING RUNNING")
        console.log("-------------------")
        let pollingres
        ...
        pollingres = await arbPollingTrade(BUY_AMOUNT, pooladdress, tokenIDs.reverse(), tokenPaths.reverse(), tokenDecimals.reverse())
        try{
